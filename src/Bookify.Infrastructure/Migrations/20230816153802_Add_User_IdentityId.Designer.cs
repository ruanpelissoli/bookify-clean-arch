...
namespace Bookify.Infrastructure.Migrations
{
    ...
    [Migration("20230816153802_Add_User_IdentityId")]
            ...
            modelBuilder.Entity("Bookify.Domain.Apartments.Apartment", b =>
                {
                    ...
                    b.OwnsOne("Bookify.Domain.Share.Money", "CleaningFee", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Share.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookify.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.OwnsOne("Bookify.Domain.Share.Money", "AmenitiesUpCharge", b1 =>
                        {
                    ...
                    b.OwnsOne("Bookify.Domain.Share.Money", "PriceForPeriod", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Share.Money", "TotalPrice", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
